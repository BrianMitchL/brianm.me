...
cycle) that still made me decide to upgrade to the iPhone XS Max.
...
[Some reports](https://www.anandtech.com/show/13392/the-iphone-xs-xs-max-review-unveiling-the-silicon-secrets)
go as far as saying the A12 Bionic CPU is 40% faster than the A11 Bionic.


The ARMv8.3 instruction set adds a new float-to-int instruction that handles
errors and out-of-range exceptions the same way that JavaScript does.
<blockquote class="twitter-tweet" data-dnt="true" data-lang="en">
...
<figure>
  ...
  <figcaption>Video example. This looks even better in 4K at 60fps with the raw
  (not YouTube compressed, 217.2 MB) file.</figcaption>
</figure>
